...
- `features/home`: empty world, main navigation shell, chat, calendar, world tools, daily morning/night rituals, profile, settings screens, and offline retry wiring for messages/posts.
